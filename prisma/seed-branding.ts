...
export function getTenantBrandingFromEnv(): TenantBrandingSeed {
  return {
    ...
    colorBg: envStr("SEED_COLOR_BG", "#FFFFFF"),
    colorFg: envStr("SEED_COLOR_FG", "#18181B"),
    colorSurface: envStr("SEED_COLOR_SURFACE", "#FAFAFA"),
    colorAccent: envStr("SEED_COLOR_ACCENT", "#FF5A2C"),
    colorAccentSoft: envStr("SEED_COLOR_ACCENT_SOFT", "#FFF1EE"),
    colorMuted: envStr("SEED_COLOR_MUTED", "#71717A"),
    colorBorder: envStr("SEED_COLOR_BORDER", "#E4E4E7"),
    colorCoach: envStr("SEED_COLOR_COACH", "#15803D"),
    colorAdmin: envStr("SEED_COLOR_ADMIN", "#1E40AF"),
