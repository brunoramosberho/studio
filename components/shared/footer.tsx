...
export function Footer() {
  ...
  const { studioName, slogan, logoUrl, instagramHandle } = useBranding();
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            ...
            <div className="mt-4 flex gap-4">
              {/* Linked to the studio's own account. It used to point at
                  instagram.com — Instagram's front page, useless to a member
                  trying to find the studio — so it's hidden until a handle is
                  set rather than sending people nowhere. */}
              {instagramHandle && (
              <a
