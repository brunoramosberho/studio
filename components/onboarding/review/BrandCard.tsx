      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <p className="mb-2 text-[11px] text-gray-400">
            Color principal de la marca. Se usa en botones, links y elementos destacados.
          </p>
          <ColorPicker value={data.primaryColor} onChange={(v) => set("primaryColor", v)} />
        </div>

        <div>
          <Label className="mb-1.5 block text-xs font-medium text-gray-500">Hero BG</Label>
          <p className="mb-2 text-[11px] text-gray-400">
            Fondo de secciones hero/oscuras de la landing.
          </p>
