...
type WaiverPhase = "loading" | "prompt" | "done";
...
export function ConfirmationScreen({
  ...
  const [waiverPhase, setWaiverPhase] = useState<WaiverPhase>("loading");
  ...
  useEffect(() => {
    ...
    fetch("/api/waiver/status")
      ...
      .catch(() => {
        if (!cancelled) setWaiverPhase("done");
      });
    ...
    <AnimatePresence mode="wait">
      {waiverPhase === "prompt" ? (
        ...
        >
          ...
          >
            Para asistir a tu clase necesitas firmar el acuerdo de
            responsabilidad de {studioName}. Solo toma un minuto.
          </motion.p>
