...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/reports", labelKey: "reports", icon: ClipboardList, permission: "analytics", keywordsKey: "kw.reports" },
      { href: "/admin/conversion", labelKey: "tabs.conversion", icon: TrendingUp, permission: "analytics", keywordsKey: "kw.conversion" },
    ],
  },
  {
