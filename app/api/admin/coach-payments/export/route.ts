...
const LABELS = {
  es: {
    ...
    studio: "Estudio",
    room: "Sala",
    attendees: "Facturables",
    attended: "Asistieron",
    noShows: "No-shows cobrados",
    lateCancels: "Canc. tardías",
    capacity: "Cupo",
    occupancy: "Ocupación",
...
export async function GET(request: NextRequest) {
  try {
    ...
    detail.columns = [
      ...
      { header: L.attended, key: "attended", width: 11 },
      { header: L.noShows, key: "noShows", width: 16 },
      { header: L.lateCancels, key: "lateCancels", width: 13 },
    ...
    for (const r of rows) {
      for (const l of r.lines) {
        detail.addRow({
          ...
          attended: l.attended,
          noShows: l.chargedNoShows,
          lateCancels: l.chargedLateCancels,
          capacity: l.capacity,
